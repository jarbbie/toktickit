...
|---|---|---|
| Login / Change Password | `artifacts/lab-03/screenshots/authentication/`: initial, mandatory mode, invalid/inactive, busy, visible identity/role, logout denial | Pass — captured and visually inspected |
